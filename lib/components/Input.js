...
var _constsQuill_format = require('../../../consts/quill_format');

var _constsQuill_format2 = _interopRequireDefault(_constsQuill_format);
...
var Input = (function (_React$Component) {
  ...
  Input.prototype.render = function render() {
    ...
    var help = _lodash2['default'].isUndefined(this.props.help) ? _validation.validationHelp(meta) : this.props.help;
    ...
    switch (type) {
      ...
      case 'image':
        control = _react2['default'].createElement(_S3Uploader.S3Uploader, { inputProps: inputProps });
        break;
      ...
      default:
        control = _react2['default'].createElement(_reactBootstrap.FormControl, _extends({ componentClass: 'input', type: type }, bsProps, inputProps));
    }
