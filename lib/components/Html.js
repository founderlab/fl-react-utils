...
var Html = (function (_Component) {
  ...
  Html.prototype.render = function render() {
    ...
    var initial_state = _props.initial_state;
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        'body',
        null,
        _react2['default'].createElement('div', { id: 'react-view', dangerouslySetInnerHTML: { __html: content } }),
        _react2['default'].createElement('script', { dangerouslySetInnerHTML: { __html: 'window.__INITIAL_STATE__=' + _serializeJavascript2['default'](initial_state) + ';' }, charSet: 'UTF-8' }),
  ...
  _createClass(Html, null, [{
    ...
    value: {
      ...
      initial_state: _react.PropTypes.object
    },
    enumerable: true
  }]);
