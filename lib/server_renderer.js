  ...
  return function app(req, res) {
    ...
    store.dispatch(_reduxRouterServer.match(req.originalUrl, function (err, redirect_location, router_state) {
      ...
      _fetch_component_data2['default']({ store: store, components: router_state.components }, function (err) {
        ...
        res.send('<!doctype html>\n' + _reactDomServer.renderToString(_react2['default'].createElement(_componentsHtml2['default'], { assets: webpack_isomorphic_tools.assets(), component: component, store: store })));
        console.log('rendering', _reactDomServer.renderToString(_react2['default'].createElement(_componentsHtml2['default'], { assets: webpack_isomorphic_tools.assets(), component: component, store: store })));
