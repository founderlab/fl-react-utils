  ...
  Html.prototype.render = function render() {
    ...
    return _react2['default'].createElement(
      ...
      _react2['default'].createElement(
        ...
        _Object$keys(assets.styles).length === 0 ? _react2['default'].createElement('style', { dangerouslySetInnerHTML: { __html: require('../theme/bootstrap.config.js') + require('../containers/App/App.scss')._style } }) : null
      ),
      _react2['default'].createElement(
        'body',
        null,
        _react2['default'].createElement('div', { id: 'content', dangerouslySetInnerHTML: { __html: content } }),
        _react2['default'].createElement('script', { dangerouslySetInnerHTML: { __html: 'window.__data=' + _serializeJavascript2['default'](store.getState()) + ';' }, charSet: 'UTF-8' }),
